...
\begin{innerlist}
  ...
  \item[] \textbf{10+ years Windows experience}
  \begin{innerlist}
    \item Desktop: Every major version from NT 4.0 through Windows 8.1
    \item Server: Every major version from NT 4.0 through Server 2012 R2
  ...
  \item[] \textbf{6+ years Linux / FreeBSD experience}
  \begin{innerlist}
    \item ZFS, NFS, Samba, DHCP, PXE, TFTP services
    \item Use of MySQL, PHP, Apache in production environments
    \item Support of 200+ Linux workstations, 2010 though current
    \item FreeBSD based systems, such as FreeNAS, pfSense, etc.
  \end{innerlist}
  ...
  \item[] \textbf{Working to provide solutions in technology for the past 14 years}
\end{innerlist}
...
\begin{innerlist}
  \item[] B.S., \href{https://cse.wwu.edu/computer-science}{Computer Science}
  \begin{innerlist}
    \item Expected graduation in August 2014
