...
% I've left almost all of the original comments and whatnot so that if
...
\begin{innerlist}
  ...
  \begin{innerlist}
    \item Elective course-work around Unix, parallel computation, and mobile device development
